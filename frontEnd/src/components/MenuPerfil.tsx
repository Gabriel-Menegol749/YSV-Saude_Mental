...
const MenuPerfil = ({ onClose }: { onClose: () => void}) => {
    ...
    const{ tema, toggleTema, aumentaFonte, diminuiFonte } = usaTema();
        ...
        <div className="menu" ref={refMenu}>
            {menuAtivo === 'principal' ? (
                <>
                    <div className="telaAcima">
                        <div className="perfil">
                            ...
                            <button className="botaoFecharMenu"  onClick={onClose}><img src={botaoX} alt="IconeX" className="IMGbotaoFecharMenu"/></button>
                        </div>
                    ...
                    <ul>
                        <li className="divisor"></li>
                            <Link to="/PerfilPessoal" className="linkToULLI">
                                <li><img src={editarPerfil} alt="" />Meu perfil</li>
                            </Link>

                        <li onClick={() => setMenuAtivo('acessibilidade')}>
                            <img src={acessibilidade} alt="" />Tela e Acessibilidade</li>


                        <li onClick={() => setMenuAtivo('ajuda')}>
                            <img src={ajuda} alt="" />Ajuda e Suporte</li>
                        ...
                        <Link to="/" className="linkToULLI">
                            <li><img src={sair} alt="" /><button className="sairConta">Sair</button></li>
                        </Link>
                    </ul>
                </>
            ) : (
                <div className="sub-menu">
                    ...
                    {menuAtivo === 'acessibilidade' ? (
                    <>
                    <div className="Tela_Acessibilidade">
                            <h3>Modo Escuro</h3>
                            <p>Ajuste a aparência do YSV para reduzir o brilho e dar um descanso para os olhos!</p>
                            <ul>
                                <label><input type="radio" checked={tema === 'Escuro'} onChange={toggleTema} />Ativado</label>
                                <label><input type="radio" checked={tema === 'Claro'} onChange={toggleTema} />Desativado</label>
                            </ul>
                            <h3>Tamanho da Fonte:</h3>
                            <ul>
                                <li>
                                    <button className="diminuiFonte" onClick={diminuiFonte}>-</button>
                                    <button className="aumentaFonte" onClick={aumentaFonte}>+</button>
                                </li>
                            </ul>
                        </div>
                    </>
